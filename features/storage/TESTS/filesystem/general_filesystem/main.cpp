...
static void FS_fopen_empty_path_r_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "", "rb")) != NULL);
    TEST_ASSERT_EQUAL(1, res);
...
static void FS_fopen_empty_path_w_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "", "wb")) != NULL);
    TEST_ASSERT_EQUAL(1, res);
...
static void FS_fopen_invalid_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "Invalid_mode", "")) != NULL);
    TEST_ASSERT_EQUAL(1, res);
...
static void FS_fopen_supported_wb_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "filename", "wb")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fopen_supported_a_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "filename", "a")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fopen_supported_r_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "filename", "r")) != NULL);
    TEST_ASSERT_EQUAL(1, res);
...
static void FS_fopen_supported_w_update_mode()
{
    ...
    int res = !((fd[0] = fopen("/default_fs/" "filename", "w+")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fopen_read_update_create()
{
    ...
    res = !((fd[0] = fopen("/default_fs/" "filename", "r+")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fopen_write_update_create()
{
    ...
    res = !((fd[0] = fopen("/default_fs/" "filename", "w+")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fwrite_valid_flow()
{
    ...
    res = !((fd[0] = fopen("/default_fs/" "filename", "rb")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_fread_with_fopen_w_mode()
{
    ...
    res = !((fd[0] = fopen("/default_fs/" "filename", "wb")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_freopen_point_to_same_file()
{
    ...
    res = !((fd[1] = freopen("/default_fs/" "new_file_name", "wb", fd[0])) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_freopen_valid_flow()
{
    ...
    res = !((fd[1] = freopen("/default_fs/" "filename", "rb", fd[0])) != NULL);
    TEST_ASSERT_EQUAL(0, res);
...
static void FS_append_non_empty_file()
{
    ...
    res = !((fd[0] = fopen("/default_fs/" "filename", "a+")) != NULL);
    TEST_ASSERT_EQUAL(0, res);
