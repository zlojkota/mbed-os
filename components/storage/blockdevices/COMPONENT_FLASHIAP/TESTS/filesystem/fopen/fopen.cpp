...
static const int MAX_TEST_SIZE = 64 * 1024 * 2;
...
int32_t fslittle_filepath_remove_all(char *filepath)
{
    ...
    while (pos != fpathbuf) {
        ...
        if (strlen(fpathbuf) == strlen(FSLITTLE_FOPEN_TEST_MOUNT_PT_PATH) &&
                strncmp(fpathbuf, FSLITTLE_FOPEN_TEST_MOUNT_PT_PATH, strlen(fpathbuf)) == 0) {
            break;
        }
        ret = remove(fpathbuf);
...
static int32_t fslittle_filepath_make_dirs(char *filepath, bool do_asserts)
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
 ...
 */
static void fslittle_fopen_test_01()
{
    char *read_buf;
    int32_t ret = 0;
    size_t len = 0;
...
void fslittle_fopen_test_02()
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                "%s:Error: failed to open file (filename=\"%s\", ret=%d)\n", __func__, fslittle_fopen_test_02_data[0].filename,
                                (int) ret);
    TEST_ASSERT_MESSAGE(fp != NULL, fslittle_fopen_utest_msg_g);
...
void fslittle_fopen_test_04()
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                ...
                                (int) strlen(filename_good), (int) FSLITTLE_FILENAME_MAX_LENGTH);
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                ...
                                (int) FSLITTLE_FILENAME_MAX_LENGTH + 1);
     ...
     *
     *  FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE, "%s:Error: failed to create file (filename=%s, ret=%d).\n", __func__, filename_good, (int) ret);
     *  TEST_ASSERT_MESSAGE(ret >= 0, fslittle_fopen_utest_msg_g);
     */
 ...
 * @return on success returns CaseNext to continue to next test case, otherwise will assert on errors.
 */
void fslittle_fopen_test_06()
{
// legal in LittleFS
#if 0
    const char *mnt_pt = FSLITTLE_FOPEN_TEST_MOUNT_PT_PATH;
    const char *extname = "txt";
    const size_t filename_len = strlen(mnt_pt) + FSLITTLE_MAX_FILE_BASENAME + strlen(extname) +
                                2; /* extra 2 chars for '/' and '.' in "/sd/goodfile.txt" */
    char filename[FSLITTLE_BUF_MAX_LENGTH];
    int32_t i = 0;
    int32_t j = 0;
...
void fslittle_fopen_test_09()
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                ...
                                fslittle_fopen_test_02_data[0].filename, (int) ret, errno);
    TEST_ASSERT_MESSAGE(ret == 0, fslittle_fopen_utest_msg_g);
...
void fslittle_fopen_test_11()
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                ...
                                fslittle_fopen_test_11_kv_data[0].filename, fslittle_fopen_test_11_kv_data[1].filename, (int) ret, errno);
    TEST_ASSERT_MESSAGE(ret == 0, fslittle_fopen_utest_msg_g);
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                "%s:Error: unable to rename file from (%s) to (%s) (ret=%d, errno=%d).\n", __func__,
                                fslittle_fopen_test_11_kv_data[1].filename, fslittle_fopen_test_11_kv_data[2].filename, (int) ret, errno);
    TEST_ASSERT_MESSAGE(ret == 0, fslittle_fopen_utest_msg_g);
...
void fslittle_fopen_test_12()
{
    ...
    *pos = '\0';
    ...
    while ((dp = readdir(dir)) != NULL) {
        ...
        FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                    "%s:Error: unexpected object name (name=%s, expected=%s).\n", __func__, dp->d_name,
                                    fslittle_fopen_test_12_kv_data[count].value);
        TEST_ASSERT_MESSAGE(strncmp(dp->d_name, fslittle_fopen_test_12_kv_data[count].value,
                                    strlen(fslittle_fopen_test_12_kv_data[count].value)) == 0, fslittle_fopen_utest_msg_g);
        count++;
    }
    closedir(dir);
...
void fslittle_fopen_test_13()
{
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                "%s:Error: failed to create dir (dirname=%s, ret=%d, errno=%d)\n", __func__, fslittle_fopen_test_13_kv_data[0].filename,
                                (int) ret, errno);
    TEST_ASSERT_MESSAGE(ret == 0, fslittle_fopen_utest_msg_g);
    ...
    FSLITTLE_TEST_UTEST_MESSAGE(fslittle_fopen_utest_msg_g, FSLITTLE_UTEST_MSG_BUF_SIZE,
                                ...
                                fslittle_fopen_test_13_kv_data[0].filename, (int) ret, errno);
    TEST_ASSERT_MESSAGE(ret != 0, fslittle_fopen_utest_msg_g);
...
int32_t fslittle_test_create_data_file(const char *filename, size_t len)
{
    ...
    while (written_len < len) {
        ...
        for (exp = 0; (exp <= exp_max) && (written_len < len); exp++) {
            ...
            ret = fwrite((const void *) &fslittle_test_byte_data_table[written_len % FSLITTLE_TEST_BYTE_DATA_TABLE_SIZE], write_len,
                         1, fp);
